  ...
  <ul>
    ...
    <li>
      <p>
        ...
        "Us" or "Our" in these Terms and Conditions) refers to Spanish Poker
        Dice.
      </p>
    </li>
    <li>
    ...
    <li>
      <p>
        ...
        regarding the Service. These Terms and Conditions have been created with
        the help of the{" "}
        <a
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Spanish Poker Dice, accessible from{" "}
        <a
